...
public class Tutorial12_1_2 {
	public static void main(String[] args) {
		try {
			...
			//Find an assigner from a file or create one if there is no existing one
			HardAssigner<byte[], float[], IntFloatPair> assigner;
			if(new File("assigner.txt").exists()) {
				assigner = IOUtils.readFromFile(new File("assigner.txt"));
			}
			else {
