...
public class Tutorial12_1_1 {
	public static void main(String[] args) {
		try {
			...
			FeatureExtractor<DoubleFV, Record<FImage>> wrappedExtractor = hkm.createWrappedExtractor(extractor);
			
			//The use of the wrapped extractor took slightly longer but did return higher accuracy compared to the previous extractor
			
			
			LiblinearAnnotator<Record<FImage>, String> ann = new LiblinearAnnotator<Record<FImage>, String>(wrappedExtractor, Mode.MULTICLASS, SolverType.L2R_L2LOSS_SVC, 1.0, 0.00001);
